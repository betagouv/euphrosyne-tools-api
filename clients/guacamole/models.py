...
class GuacamoleConnectionCreateParametersData(BaseModel):
    ...
    resize_method: str = Field("dislay-update", alias="resize-method")
    enable_font_smoothing: str = Field("true", alias="enable-font-smoothing")
    enable_driver: str = Field("true", alias="enable-driver")
    ...
    remote_app_dir: str = Field("", alias="remote_app_dir")
