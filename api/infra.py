...
def update_guacamole_webapp_guacd_hostname(
    ...
    """This webhook is meant to be called when Azure changes guacd configuration. It checks if
    guacamole client has correct guacd IP address in its settings and changes it otherwise.
    This prevents communication breakdown between guacd and guacamole client due to automatic Azure
    update.
    """
